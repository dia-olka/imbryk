...
- [ ] Verify end-to-end: newsroom-director writes edition + index → triggers deploy hook → gazette builds from R2
...
- [ ] Create Cloud Scheduler job for News Scout (~03:00 UTC, ~3 hours before morning batch)
- [ ] Add `TAVILY_API_KEY` to GCP Secret Manager
